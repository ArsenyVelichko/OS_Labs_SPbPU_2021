...
public:
	...
	UnixHostAddress(const UnixHostAddress& other);
	~UnixHostAddress();

	friend void swap(UnixHostAddress& first, UnixHostAddress& second);
	UnixHostAddress& operator=(UnixHostAddress other);
